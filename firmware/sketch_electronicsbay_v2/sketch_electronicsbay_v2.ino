...
float runtime = 0.0; //timestamp since start
...
{ 
  ...
  Serial1.begin(9600); //connect LORA serial
...
{ 
  ...
  Serial1.write(",");
  Serial1.print(lat*100000);
  Serial1.write(",");
  Serial1.print(lon*100000);
  Serial1.write(","); 
  Serial1.print(alt_gps, 6);
  Serial1.write(",");
  Serial1.print(num_sats);
  Serial1.write(",");
  Serial1.print(acc_x);
  Serial1.write(",");
  Serial1.print(acc_y);
  ...
  Serial1.write(",");
  Serial1.print(pressure_mpl);
  Serial1.write(",");
  Serial1.print(temperature_mpl);
}
